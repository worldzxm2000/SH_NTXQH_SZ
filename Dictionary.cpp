...
Dictionary::Dictionary()
{
	...
	//溶解度
	map.insert("awa", "DissolvedOx");
	//电导率
	map.insert("awb", "ECValue");
	//浊度
	map.insert("awc", "Turbidity");
	//PH值
	map.insert("awd", "PHValue");
	//ORP
	map.insert("awe", "WaterORP");
	//水温
	map.insert("awf", "WaterTemp");
	//深度
	map.insert("awg", "WaterDepth");
	...
	//溶解度状态
	map.insert("y_awa", "DissolvedOxSts");
	//电导率状态
	map.insert("y_awb", "ECSts");
	//浊度状态
	map.insert("y_awc", "TurbiditySts");
	//PH值状态
	map.insert("y_awd", "PHSts");
	//ORP状态
	map.insert("y_awe", "WaterORPSts");
	//水温状态
	map.insert("y_awf", "WaterTempSts");
	//深度状态
	map.insert("y_awg", "WaterDepthSts");
}
